...
public class LockScreenView extends View {
	...
	private onPinDrawFinishListener listener = null;
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_UP:
			...
			Toast.makeText(context, "lockPin = " + lockPin, Toast.LENGTH_SHORT)
					.show();
			if(listener!=null){
	...
	public interface onPinDrawFinishListener{
		void onFinish(String lockpin);
	}
	
	public void setOnPinDrawFinishListener(onPinDrawFinishListener listener){
